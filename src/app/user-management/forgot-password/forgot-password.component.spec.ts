...
describe('ForgotPasswordComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ForgotPasswordComponent, VerifyEmailComponent, VerifyCodeComponent, SetPasswordComponent, ValidateOnBlurDirective],
  ...
  describe('verifyEmail()', () => {
    ...
    it('should return mock response', async(() => {
      component.userModel.registration = false;
    ...
    it('should increment the current step to two and set the response result', async(() => {
      ...
      expect(component.userDetails.email).toEqual(component.userModel.email);
      expect(component.userModel.registration).toEqual(false);
      service.verifyEmail(component.userModel)
        .subscribe(response => {
  ...
  describe('verifyCode()', () => {
    ...
    it('should increment the current step to three', async(() => {
      component.userModel.code = '1234';
